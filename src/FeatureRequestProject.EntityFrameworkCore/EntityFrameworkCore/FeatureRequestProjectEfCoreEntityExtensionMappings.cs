...
public static class FeatureRequestProjectEfCoreEntityExtensionMappings
{
    ...
    public static void Configure()
    {
        ...
        OneTimeRunner.Run(() =>
        {
                 ...
                 * USE FeatureRequestProjectModuleExtensionConfigurator CLASS (in the Domain.Shared project)
